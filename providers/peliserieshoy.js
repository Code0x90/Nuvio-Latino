        ...
        return P(this, null, function* () {
          try {
            ...
            if (s.u && s.sig) {
              ...
              return { name: "Solo Latino", title: `1090p \xB7 ${f} \xB7 ${h}`, url: i, quality: "1080p", headers: { Referer: c } };
            }
            if (s.u && !s.sig) {
            ...
            if (s.type === "mp4" && s.u) {
              ...
              return { name: "Solo Latino", title: `1090p \xB7 ${f} \xB7 ${i}`, url: s.u, quality: "1080p", headers: { Referer: c } };
            }
          } catch (s) {
